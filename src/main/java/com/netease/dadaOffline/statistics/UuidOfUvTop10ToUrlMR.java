...
public class UuidOfUvTop10ToUrlMR extends MRJob {

    @Override
    public boolean init(String date) {

        inputList.add(DirConstant.COMMON_DATA_DIR +"docidAndUrlOfRarticle/"+ date);
        inputList.add(DirConstant.STATISTICS_TEMP_DIR + "weeklyPvUvTop10/" + date+"/uv/");
        outputList.add(DirConstant.STATISTICS_TEMP_DIR + "weeklyArticleUvTop10Url/" + date);
        return true;
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        MultipleInputs.addInputPath(job1, new Path(inputList.get(1)), SequenceFileInputFormat.class, UvTop10Mapper.class);
        ...
        // reducer
        job1.setReducerClass(ArticleUvReducer.class);
    ...
    public static class UvTop10Mapper extends Mapper<Text, IntWritable, Text, StringStringWritable> {
    ...
    public static class ArticleUvReducer
