...
public class UuidOfShareTop10ToUrlMR extends MRJob {

    @Override
    public boolean init(String date) {

        inputList.add(DirConstant.COMMON_DATA_DIR +"docidAndUrlOfRarticle/"+ date);
        inputList.add(DirConstant.STATISTICS_TEMP_DIR + "weeklyArticleShareTop10/" + date);
        outputList.add(DirConstant.STATISTICS_TEMP_DIR + "weeklyArticleShareTop10Url/" + date);
        return true;
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        MultipleInputs.addInputPath(job1, new Path(inputList.get(1)), SequenceFileInputFormat.class, ShareTop10Mapper.class);
    ...
    public static class ShareTop10Mapper extends Mapper<Text, IntWritable, Text, StringStringWritable> {
