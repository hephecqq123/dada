...
public class UuidOfPvTop10ToUrlMR extends MRJob {

    @Override
    public boolean init(String date) {

        inputList.add(DirConstant.COMMON_DATA_DIR +"docidAndUrlOfRarticle/"+ date);
        inputList.add(DirConstant.STATISTICS_TEMP_DIR + "weeklyPvUvTop10/" + date+"/pv/");
        outputList.add(DirConstant.STATISTICS_TEMP_DIR + "weeklyArticlePvTop10Url/" + date);
        return true;
    }
    ...
    public int run(String[] args) throws Exception {
        ...
        MultipleInputs.addInputPath(job1, new Path(inputList.get(1)), SequenceFileInputFormat.class, PvTop10Mapper.class);
        ...
        // reducer
        job1.setReducerClass(ArticlePvReducer.class);
    ...
    public static class PvTop10Mapper extends Mapper<Text, IntWritable, Text, StringStringWritable> {
    ...
    public static class ArticlePvReducer
